...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> fundingIntervalHour</td><td>string</td><td>資金費結算間隔（小時）<ul><li>目前僅支持整點小時</li></ul></td>
        </tr>
        <tr>
            <td>> fundingCap</td><td>string</td><td>資金費率上限和下限</td>
        </tr>
        <tr>
...
### 響應示例
<Tabs groupId="market-category">
<TabItem value="inverse" label="Linear">
