...
| 參數 | 是否必需 | 類型 | 說明|
|:----- |:-------|:-----|------ |
|[accountType](../enum#accounttype) |**true** |string |帳戶類型. <ul><li>統一类型帳戶: `UNIFIED`</li><li>經典帳戶: `CONTRACT`(合約錢包)</li></ul>|
...
|> accountIMRate |string |帳戶初始保證金率 <li>下面所有帳戶維度的字段都<b>不適用於</b><br/>統一帳戶(逐倉模式), <br/>經典帳戶(CONTRACT)</li>|
