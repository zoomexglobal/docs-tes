...
---
該接口支持切換USDT永續持倉模式。如果處於單向持倉模式下，您只能要麼持有多頭要麼空頭倉位；如果處於雙向持倉模式下，您可以同時持倉多頭和空頭的倉位。
> **普通帳戶覆蓋範圍: USDT永續**
...
<table class="custom_table">
    <tr>
        <th></th><th>經典帳戶</th><th>統一帳戶</th>
    </tr>
    <tr>
        <td>USDT 永續</td><td><b>支持單雙向持倉</b></td><td><b>支持單雙向持倉</b></td>
    </tr>
    <tr>
        <td>USDT 交割</td><td>N/A</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>USDC 永續</td><td>N/A</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>USDC 交割</td><td>N/A</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>反向永續</td><td>僅支持單向持倉</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>反向交割</td><td><b>支持單雙向持倉</b></td><td>僅支持單向持倉</td>
    </tr>
</table>
...
| 參數 | 是否必需 | 類型 | 說明|
|:----- |:-------|:-----|------ |
|category |**true** |string |產品類型 <ul><li>普通帳戶: `linear`, `inverse`. _這裡`category`字段不參與業務邏輯，僅做路由使用_</li></ul> |
