...
|data |array |Object |
|> category |string |Product type <ul><li>Normal account: `linear`, `inverse`.</li></ul>|
...
|> closeOnTrigger |boolean |Close on trigger. <a href="https://www.zoomex.com/en-US/help-center/bybitHC_Article?language=en_US&id=000001050">What is a close on trigger order?</a> |
