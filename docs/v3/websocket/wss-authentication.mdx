...
---
:::caution
* The V3 version of the push is expected to go offline on September 23, 2025
* please complete the switch as soon as possible
...
- **Mainnet:**<br/>
Spot: `wss://stream.zoomex.com/v5/public/spot`<br/>
USDT perpetual: `wss://stream.zoomex.com/v5/public/linear`<br/>
Inverse contract: `wss://stream.zoomex.com/v5/public/inverse`<br/>

- **Testnet:**<br/>
Spot: `wss://stream-testnet.zoomex.com/v5/public/spot`<br/>
USDT perpetual: `wss://stream-testnet.zoomex.com/v5/public/linear`<br/>
Inverse contract: `wss://stream-testnet.zoomex.com/v5/public/inverse`<br/>
