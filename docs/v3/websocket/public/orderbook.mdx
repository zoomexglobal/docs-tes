...
|> seq |integer |Cross sequence. _Options does not have this field for now_ <li>You can use this field to compare different levels orderbook data, and for the smaller seq, then it means the data is generated earlier. </li> |
