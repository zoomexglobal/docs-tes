...
|:----- |:-------|:-----|------ |
|category |**true** |string |Product type <ul><li> Unified account: `linear`, USDT Perp; `inverse`, Inverse Futures</li><li>Normal account: `linear`, USDT Perp; `inverse`, Inverse Futures. _Please note that `category` is **not** involved with business logic_</li></ul> |
