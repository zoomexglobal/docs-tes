...
Query for historical <a href="https://www.zoomex.com/data/basic/linear/index-price/premium-index?symbol=BTCUSDT">premium index</a> klines. Charts are returned in groups based on the requested interval.
