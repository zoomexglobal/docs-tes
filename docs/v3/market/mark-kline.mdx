...
Query for historical <a href="https://www.zoomex.com/en-US/help-center/s/article/Glossary-Zoomex-Trading-Terms">mark price</a> klines. Charts are returned in groups based on the requested interval.
