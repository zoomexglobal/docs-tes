...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>>> minNotionalValue</td><td>string</td><td>Minimum order notional Value </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>> offlineTime</td><td>string</td><td>offline time of the currency pair, UTC time.
            If the symbol is not listed or is in use, it will return empty; if it is about to be offline, it will return the offline time </td>
        </tr>
        <tr>
            <td>> tags</td><td>array</td><td>Symbol tags </td>
        </tr>
    </table>
</TabItem>
...
<TabItem value="spot" label="Spot">
    <table border="0.8">
        ...
        <tr>
            <td>> offlineTime</td><td>string</td><td>Offline timestamp (ms) </td>
        </tr>
        <tr>
            <td>> tags</td><td>array</td><td>Symbol tags </td>
        </tr>
