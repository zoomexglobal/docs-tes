...
By category="inverse", you can query Inverse Contract data occurred during classic account

### HTTP Request
GET `/cloud/trade/v3/pre-upgrade/position/closed-pnl`

### Request Parameters
| Parameter | Required | Type | Comments|
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li>`linear`, `inverse`</li></ul> |
...
```shell
GET /cloud/trade/v3/pre-upgrade/position/closed-pnl?category=linear&limit=1 HTTP/1.1
