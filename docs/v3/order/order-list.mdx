...
* Trading account(except inverse) support querying the past 2 years data.
:::
...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li>Trading account: `linear`, `inverse`, `spot`</li><li>Normal account: `linear`, `inverse`, `spot`</li></ul> |
