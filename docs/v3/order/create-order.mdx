...
**Spot: * * Supports a total of 500 pending orders, including a maximum of 30 stop loss orders.<br/>
Rules for spot stop loss orders<br/>
Spot support stop loss orders, but the underlying processing logic is slightly different<br/>
