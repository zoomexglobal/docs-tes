...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li>UTA: `spot`,`linear`, `inverse`</li><li>Normal account: `spot`, `linear`, `inverse`</li></ul>|
...
|success |string |"1": success, "0": fail<li>uta(inverse), classic(linear, inverse) do not return this field</li>|
