...
|:----- |:-------|:-----|------ |
|[accountType](../enum#accounttype) |**true** |string |Account type <ul><li>Trading account: `UNIFIED`</li><li>Classic account: `CONTRACT`</li></ul> |
...
|> accountIMRate |string |Account IM rate <li>All account wide fields are <b>not</b> applicable to <br/>Trading account(isolated margin), <br/>classic account(CONTRACT)</li>|
