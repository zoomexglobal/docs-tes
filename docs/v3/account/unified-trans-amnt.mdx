---
title: Get Transferable Amount (Trading account)
sidebar_label: Get Transferable Amount (Trading account)
sidebar_position: 1.5
---
Query the available amount to transfer of a specific coin in the Unified wallet.

### HTTP Request
GET `/cloud/trade/v3/account/withdrawal`
...
```http
GET /cloud/trade/v3/account/withdrawal?coinName=BTC,SOL,ETH,XRP HTTP/1.1
