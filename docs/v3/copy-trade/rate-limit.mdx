...
<table border="0.8">
    ...
    <tr>
        <td>/cloud/contract/v3/private/copytrading/position/set-leverage</td><td rowSpan="3">75 req/min</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/position/close</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/position/list</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/order/create</td><td rowSpan="4">100 req/min</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/order/close</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/order/cancel</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/order/list	</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/wallet/balance</td><td rowSpan="2">120 req/min</td><td>1/request</td>
    </tr>
    <tr>
        <td>/cloud/contract/v3/private/copytrading/wallet/transfer</td><td>1/request</td>
    </tr>
</table>
</span>

## How to increase API Limit
Please email support@zoomex.com with the following information. We will reply within 1-4 working days:
